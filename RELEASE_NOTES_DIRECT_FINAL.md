...
- The compiled Android router itself now removes the Pi Wi-Fi component from `/wifi-setup` and uses the safe Settings fallback, eliminating the remaining black-screen path.
