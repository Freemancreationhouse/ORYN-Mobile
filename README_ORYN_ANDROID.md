...
**Mobile branch:** ORYN-ANDROID-STANDALONE-1.0.0  
**Locked source baseline:** PF-PRO-V10.4.1-20260828-1  
**Locked motion baseline:** UC-DUNE-MOTION-V9-20260827-1 — unchanged on the Pi
...
3. The completed debug APK is copied to `ORYN-Mobile-V10.4.1-debug.apk` in the project root.
...
The included `.github/workflows/build-android-apk.yml` builds the Android APK on push to `main` or from **Actions → Build ORYN Android APK → Run workflow**. The resulting artifact is named **ORYN-Mobile-V10.4.1-APK**.

## Android package

- Application ID: `com.studiokinematics.oryn`
- Version name: `10.4.1-mobile1`
- Version code: `1040101`
