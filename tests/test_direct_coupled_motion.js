...
// Match the physically measured compact 28BYJ/Mini profile.
const thetaRev=50, rhoTravel=22.2, rhoDirection=1, xSteps=256, ySteps=210, gear=6.25, sourceSign=-1;
const x5Compensation=5*(xSteps/(gear*ySteps))*sourceSign;
if(Math.abs(x5Compensation-(-0.9752380952380952))>1e-12)
  throw new Error('Measured X5 coupling compensation mismatch: '+x5Compensation);
